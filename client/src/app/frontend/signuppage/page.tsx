                ...
                <button className="absolute top-3 right-4 text-white text-lg">✕</button>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="relative">
                            ...
                            />
                            {errors.password && (
                                <p className="mt-1 ml-3 text-xs text-red-500">{errors.password}</p>
                            )}
                        </div>
                        ...
                        <button
                            type="button"
                            className="flex w-full items-center justify-center space-x-2 rounded-full border bg-amber-500 border-gray-300 py-2 px-4 text-gray-700 hover:bg-amber-300 dark:border-gray-600 dark:text-gray-300 hover:bg-amber-300"
                        >
